<!--
    NoiseHero.svelte — the page's opening explanation. The copy describes what
    Noise is, why it exists as a family of patterns, and why this friendlier
    guide was built alongside the dense official spec.
-->
<style>
    .hero {
        padding: 56px 0 28px;
